...
class ProductListItem extends React.PureComponent {
  ...
  render() {
    ...
    console.log("this.props.adminview",this.props.isAdminView);
    return (
      <TouchableOpacity
        activeOpacity={0.5}
        onPress={() => {
        ...
        <View style={styles.container}>
          ...
          <View style={{ flex: 1, justifyContent: "flex-start" }}>
            <View style={styles.infoContainer}>
              ...
              {this.props.isAdminView==undefined ? null :this.props.isAdminView? <Ionicons
                name={wish ? "ios-trash" : "ios-trash-outline"}
                size={32}
                color="#00ff80"
